...
@section('title','Admin Panel | Haqqında | Redaktə et')
@section('content')
    <!-- Main Container -->
            ...
            <div class="content content-full">
                <div class="d-flex flex-column flex-sm-row justify-content-sm-between align-items-sm-center">
                    ...
                    <nav class="flex-sm-00-auto ml-sm-3" aria-label="breadcrumb">
                        <ol class="breadcrumb">
                            <li class="breadcrumb-item">Haqqında</li>
        ...
        <div class="content content-full content-boxed">
            ...
            <div class="block block-rounded">
                <div class="block-content">
                    <form id="form-add" method="POST" action="{{route('about_edit_post')}}" enctype="multipart/form-data">
                    @csrf
                    <!-- News add -->
                        ...
                        <div class="row push">
                            <div class="col-lg-12">
                                <div class="form-group">
                                    ...
                                    <div>
                                        <img src="{{asset('assets/media/about/'.$about->image)}}" class="img-fluid mb-4"
                                ...
                                <div class="form-group">
                                    ...
                                    <textarea class="form-control summernote"  id="summernote"
                                              style="height: 250px"
                                              name="contentt"> {{$about->content}}</textarea>
                                </div>
                            </div>
                        </div>
                        <!-- END News add -->
