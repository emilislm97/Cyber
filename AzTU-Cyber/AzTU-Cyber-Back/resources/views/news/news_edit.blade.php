...
@section('title','Admin Panel | Postlar | Redaktə et')
@section('content')
    <!-- Main Container -->
        ...
        <div class="content content-full content-boxed">
            ...
            <div class="block block-rounded">
                <div class="block-content">
                    <form id="form-add" method="POST" action="{{route('news_edit_post',$news->id)}}" enctype="multipart/form-data">
                    @csrf
                    <!-- News add -->
                            ...
                            <div class="col-lg-12">
                                <div class="form-group">
                                    ...
                                    <select class="form-control" id="type" name="type">
                                        ...
                                        <option value="xeber" @if($news->type == 'xeber') selected @endif>Xəbər</option>
                                        <option value="meqale" @if($news->type == 'meqale') selected @endif>Məqalə</option>
                                    </select>
                                </div>
                                <div class="form-group">
                                    <label for="name">Ad</label>
                                    <input type="text" class="form-control" id="name" value="{{$news->name}}"
                                           name="name">
                                </div>
                                <div class="form-group">
                                    <label for="current_image">Cari Şəkil</label>
                                    <div>
                                        <img src="{{asset('assets/media/news/'.$news->image)}}" class="img-fluid mb-4"
                                             style="max-width: 250px" alt="{{$news->name}}">
                                    </div>
                                </div>
                                <div class="form-group">
                                ...
                                <div class="form-group">
                                    ...
                                    <textarea class="form-control summernote"  id="summernote"
                                              style="height: 250px"
                                              name="contentt"> {{$news->content}}</textarea>
                                </div>
                            </div>
                        </div>
                        <!-- END News add -->
